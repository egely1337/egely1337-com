...
export default function Blog(props: {
    ...
    return(
        <>
            <Link ref={ref} href={props.link} className={`${props.className} w-auto p-4 flex flex-col justify-start items-start duration-[1s] ${inView ? "" : "translate-y-[20px] opacity-0"}`}>
